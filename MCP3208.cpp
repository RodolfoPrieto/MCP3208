 ...
 *  @file MCP3208.cpp
 *
 *  @mainpage MICROCHIP MCP3208 - 8-Channel 12-Bit ADC
 *
 *  @section intro_sec Introduction
 *
 *  This is a library for the MCP3208 - 8-Channel 12-Bit ADC.
 *
 *  Designed to work with MICROCHIP's MCP3208.
 * 
 *  These breakout use SPI to communicate, 4 pins are required
 * 
 *  This code was modified from Adafruit's MCP3008 library
 * 
 *  @section redistribution Redistribution
 * 
 * In agreement with the MIT License:
 * 
 *      Adafruit_MCP3008.cpp
 *      Adafruit MCP3008 - 8-Channel 10-Bit ADC
 *      Introduction
 ...
 */
bool MCP3208::begin(uint8_t cs, SPIClass *theSPI) {
  hwSPI = true;
 ...
 *    @return true if process is successful
 */
bool MCP3208::begin(uint8_t sck, uint8_t mosi, uint8_t miso,
                             uint8_t cs) {
  hwSPI = false;
 ...
 */
int MCP3208::readADC(uint8_t channel) {
 ...
 */
int MCP3208::readADCDifference(uint8_t differential) {
...
int MCP3208::SPIxADC(uint8_t channel, bool differential) {
